...
const events: Event[] = [
  {
    ...
    date: "September 2024",
    description:
      "Intensive 3-day workshop covering modern web development technologies including React, TypeScript, and API integration.",
    type: "workshop",
  ...
  },
  {
    ...
    date: "October 2024",
    description:
      "Annual competitive programming event testing algorithmic problem-solving skills with prizes for top performers.",
    type: "competition",
    registrationLink: "#register",
  },
  {
    ...
    date: "November 2024",
    description:
      "Industry professionals share experiences and insights about careers in IT, featuring Q&A sessions.",
    type: "seminar",
    registrationLink: "#register",
  },
  {
    ...
    date: "December 2024",
    description:
      "48-hour hackathon focused on developing solutions for real-world problems using emerging technologies.",
    type: "hackathon",
    registrationLink: "#register",
  },
];

const getEventIcon = (type: Event["type"], size = "w-6 h-6") => {
  switch (type) {
    case "workshop":
  ...
  return (
    <section id="events" className="relative pt-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto relative" ref={containerRef}>
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16 sm:mb-24 font-gambetta">
          Organized Events
        </h2>
          ...
          {events.map((event, index) => (
            <motion.div
              ...
              className={`
                ...
                sm:w-1/2 w-full
                ${index % 2 === 0 ? "sm:pr-8" : "sm:pl-8 ml-auto"}
              `}
            >
              ...
              >
                ...
                >
                  <div className="text-primary">
                    {getEventIcon(event.type, "w-5 h-5")}
                  </div>
                </motion.div>
              </div>
