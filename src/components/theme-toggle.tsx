      ...
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="flex h-8 w-16 items-center rounded-full bg-slate-200/80 p-0.5 dark:bg-slate-700">
          <div className="flex w-full items-center justify-between px-2.5">
            <Sun
              className={`h-4 w-4 ${!isDark ? "text-yellow-500 drop-shadow-[0_0_4px_rgba(250,204,21,0.6)]" : "text-slate-400"} transition-colors duration-200`}
            />
            <Moon
              className={`h-4 w-4 ${isDark ? "text-custom-white drop-shadow-[0_0_4px_rgba(96,165,250,0.6)]" : "text-slate-400"} transition-colors duration-200`}
            />
          </div>
          <div
